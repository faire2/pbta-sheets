    ...
    <>
      ...
      <main className="mx-auto w-full max-w-2xl flex-1 px-5 pt-10 pb-16 sm:px-8">
        <header className="mb-8">
          ...
          <p className="text-ink-soft mt-4 max-w-prose font-sans text-[1.102rem] leading-relaxed italic">
            {t("picker.lede")}
          </p>
        </header>
            ...
            <li key={skin.id}>
              ...
              >
                ...
                <span className="min-w-0 flex-1">
                  <span className="font-display text-ink block text-[1.696rem] leading-none tracking-wide">
                    {skin.name}
                  </span>
                  <span className="text-ink-soft mt-1.5 block font-sans text-[1.102rem] leading-snug italic">
                    {skin.tagline}
                  </span>
                </span>
                <span
        ...
        <p className="text-ink-faint mt-8 font-sans text-[0.928rem] leading-relaxed">
          {t("picker.footnote")}
        </p>
